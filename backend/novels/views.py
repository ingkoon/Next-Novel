...
from novels.models import NovelComment, Novel, NovelLike, Genre, NovelContent, NovelContentImage
from novels.serializers import NovelPreviewSerializer, NovelDetailSerializer, \
    ...
    NovelEndSerializer, NovelReadSerializer
...
class NovelStartAPI(APIView):
    ...
    def post(self, request, **kwargs):
        ...
        response_data = {
            ...
            "story": story,
            "images": {
                i + 1: images[i].image.url for i in range(len(images))
            },
            # "query": {
            #     "1": next_novel_content.query1,
            #     "2": next_novel_content.query2,
            #     "3": next_novel_content.query3,
            # },
            "caption": {
                i + 1: caption[i] for i in range(len(caption))
            }
        }
