...
export default function Snakegame({ state }) {
  ...
  const [maxscore, setMaxscore] = useState(
    localStorage.getItem("snakegame_score")
  );
      ...
      <div className={style.loadingmodal}>
        ...
        <div className={style.gamepart}>
          ...
          <div className={style.gameover} id="gameover" onClick={replay}>
            <div data-txt="GAME OVER" className={style.gameovertxt}>
              GAME OVER
            </div>
          </div>
          <div
          ...
          >
            <div data-txt="READY" className={style.starttxt}>
              READY
            </div>
          </div>
